        ...
        <div class="bo-section" data-section="ai-agent">
            ...
            <div class="bo-section-items mt-1 space-y-0.5 pl-5">
                ...
                <a href="{{ route('backoffice.ai-agent') }}"
                    class="bo-nav-item group flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm transition {{ $active === 'ai-agent' ? 'bg-white/15 font-semibold text-white' : 'text-white/70 hover:bg-white/10 hover:text-white/90' }}">
                    <svg class="h-4 w-4 shrink-0 {{ $active === 'ai-agent' ? 'text-white' : 'text-white/50 group-hover:text-white/70' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" width="16"
                        height="16">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('backoffice.forbidden.index') }}"
                    class="bo-nav-item group flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm transition {{ ($boActive ?? ($active ?? '')) === 'forbidden' ? 'bg-white/15 font-semibold text-white' : 'text-white/70 hover:bg-white/10 hover:text-white/90' }}">
                    <svg class="h-4 w-4 shrink-0 {{ ($boActive ?? ($active ?? '')) === 'forbidden' ? 'text-white' : 'text-white/50 group-hover:text-white/70' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" width="16"
                        height="16">
                        <path stroke-linecap="round" stroke-linejoin="round"
