                                    ...
                                    <div class="rounded-2xl border border-white/10 bg-slate-900/50 px-4 py-3">
                                        ...
                                        @if ($setting->type === 'secret')
                                            <input id="setting_{{ $setting->id }}" type="password"
                                                ...
                                                autocomplete="new-password" style="color:#000"
                                                class="mt-1 block w-full rounded-xl border border-white/10 bg-slate-900 px-3 py-2 text-sm text-black outline-none transition placeholder:text-slate-500 focus:border-cyan-400" />
                                        ...
                                        @elseif ($setting->type === 'url')
                                            <input id="setting_{{ $setting->id }}" type="url"
                                                ...
                                                placeholder="https://..." style="color:#000"
                                                class="mt-1 block w-full rounded-xl border border-white/10 bg-slate-900 px-3 py-2 text-sm text-black outline-none transition placeholder:text-slate-500 focus:border-cyan-400" />
