...
@section('content')
    <div class="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
        <h1 class="text-3xl font-semibold">Register Tool</h1>
        <p class="mt-2 text-sm text-slate-300">Tool untuk registrasi akun player baru.</p>
    </div>
    ...
    <div class="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
        ...
        <p class="mt-1 text-xs text-slate-400">Tool key: register</p>

        <form method="POST" action="{{ route('backoffice.tools.register.update') }}" class="mt-6 space-y-4">
            @csrf
    ...
    <div class="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
        ...
        <p class="mt-1 text-sm text-slate-300">Recent register requests processed by AI agent.</p>
