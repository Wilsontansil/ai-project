    ...
    public function run(): void
    {
        ...
        $tools = [
            ...
            [
                ...
                'description'  => 'Permintaan ganti rekening player. Wajib kumpulkan data rekening lama, rekening baru, dan verifikasi KTP yang valid sebelum eksekusi.',
                ...
                'parameters'   => [
                    ...
                    'properties' => [
                        ...
                        'nama_ktp'    => ['type' => 'string', 'description' => 'Nama pada KTP (hasil ekstraksi dari gambar KTP yang valid)'],
                    ],
                ...
                'keywords'         => null,
                'tool_rules'       => "- Kumpulkan data rekening lama terlebih dahulu: namarek, norek, bank\n- Kumpulkan data rekening baru: namarek_new (nama pemilik rekening baru) dan norek_new (nomor rekening baru)\n- Setelah data rekening lama dan baru lengkap, minta user mengirimkan foto KTP yang jelas\n- Validasi KTP wajib: harus terlihat label NIK, Nama, Agama, dan Berlaku Hingga\n- Ekstrak hanya field \"Nama\" dari gambar KTP sebagai nilai nama_ktp\n- Nilai nama_ktp HANYA boleh diambil dari gambar KTP, jangan ambil dari chat user atau field rekening\n- Jika validasi gambar gagal, set nama_ktp = '' lalu minta user kirim ulang foto KTP yang valid\n- Jangan eksekusi sebelum semua 6 data lengkap (namarek, norek, bank, namarek_new, norek_new, nama_ktp)\n- Setelah berhasil, konfirmasi bahwa rekening bank berhasil diperbarui",
                'information_text' => null,
                'vision_config'    => [
                    'requires_image'    => true,
