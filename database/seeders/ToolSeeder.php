...
class ToolSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $tools = [
            ...
            [
                'tool_name' => 'parlay_rules_info',
                'display_name' => 'Parlay Rules Info',
                'description' => 'Provide information about Mix Parlay rules including what happens when a match result is Lose, Draw, or Won Half.',
                'slug' => 'parlay-rules-info',
                'type' => 'info',
                'is_enabled' => true,
                'data_model_id' => null,
                'parameters' => null,
                'endpoints' => null,
                'keywords' => ['parlay', 'mix parlay', 'parlay kalah', 'parlay seri', 'parlay draw', 'menang setengah', 'won half', 'tiket parlay', 'parlay gugur', 'lose parlay', 'aturan parlay', 'parlay rules'],
                'tool_rules' => "- Jawab HANYA dari information text yang tersedia\n- Jelaskan dengan bahasa yang mudah dipahami\n- Jika member bertanya tentang kasus spesifik (lose/draw/won half), jawab sesuai bagian yang relevan\n- Gunakan tone ramah dan informatif",
                'information_text' => [
                    ...
                    "Jika tebakan hasilnya seri (Draw) dan tidak ada sistem handicap yang memenangkan salah satu pihak, maka status pertandingan tersebut dianggap Draw. Nilai odds untuk pertandingan yang seri akan diubah menjadi 1 (tidak mempengaruhi perkalian), dan tiket tetap berjalan dengan sisa pertandingan lainnya.",
                    "Menang Setengah (Won Half) terjadi jika tim yang dipilih menang berdasarkan sistem handicap (voor), tetapi selisih golnya hanya mencapai setengah dari nilai handicap tersebut. Tiket tetap hidup, tetapi nilai odds tim tersebut akan dihitung ulang dengan rumus khusus sebelum dikalikan dengan tim lain.",
                ],
                'meta' => null,
            ],
            [
                'tool_name' => 'parlay_calculation_info',
                'display_name' => 'Parlay Calculation Info',
                'description' => 'Provide information about Mix Parlay calculations including Won Half odds formula, total odds calculation, payout calculation, and what happens when a match is postponed or void.',
                'slug' => 'parlay-calculation-info',
                'type' => 'info',
                'is_enabled' => true,
                'data_model_id' => null,
                'parameters' => null,
                'endpoints' => null,
                'keywords' => ['hitung parlay', 'odds parlay', 'kalkulasi parlay', 'payout parlay', 'rumus parlay', 'menang setengah odds', 'won half odds', 'total odds', 'pertandingan batal', 'postponed', 'void parlay', 'cara hitung parlay', 'kemenangan parlay'],
                'tool_rules' => "- Jawab HANYA dari information text yang tersedia\n- Gunakan contoh angka jika perlu untuk memperjelas perhitungan\n- Jelaskan dengan bahasa yang mudah dipahami\n- Gunakan tone ramah dan informatif",
                'information_text' => [
                    "Rumus untuk menghitung odds Menang Setengah (Won Half) adalah: (Nilai Odds awal - 1) dibagi 2, kemudian ditambah 1. Hasil angka ini yang akan dikalikan dengan odds pertandingan lainnya.",
                    "Total odds dalam Mix Parlay dihitung dengan mengalikan semua odds dari pertandingan yang dipilih. Misalnya, jika memilih 3 tim dengan odds 1.80, 2.00, dan 1.50, maka total odds adalah: 1.80 x 2.00 x 1.50 = 5.40.",
                    "Total kemenangan (payout) dihitung dengan mengalikan total odds dengan nominal modal taruhan, kemudian dikurangi dengan modal awal tersebut jika ingin melihat keuntungan bersih.",
                    "Jika pertandingan dibatalkan atau ditunda (Postponed) melewati batas waktu tertentu (biasanya 24 jam), pertandingan tersebut akan dianggap batal (Void). Nilai odds untuk pertandingan itu akan diubah menjadi 1, sehingga tidak mempengaruhi status menang/kalah dari sisa tiket Parlay.",
                ],
                'meta' => null,
            ],
            [
                'tool_name' => 'betting_types_info',
                'display_name' => 'Betting Types Info',
                'description' => 'Provide information about common sports betting types including HDP (Asian Handicap), Over/Under (O/U), 1x2, and Odd/Even (O/E).',
                'slug' => 'betting-types-info',
                'type' => 'info',
                'is_enabled' => true,
                'data_model_id' => null,
                'parameters' => null,
                'endpoints' => null,
                'keywords' => ['hdp', 'handicap', 'asian handicap', 'voor', 'over under', 'o/u', 'atas bawah', '1x2', 'odd even', 'o/e', 'ganjil genap', 'jenis taruhan', 'tipe taruhan', 'betting type'],
                'tool_rules' => "- Jawab HANYA dari information text yang tersedia\n- Jika member bertanya tentang jenis taruhan spesifik, jawab sesuai bagian yang relevan\n- Jelaskan dengan bahasa yang mudah dipahami\n- Gunakan tone ramah dan informatif",
                'information_text' => [
                    "HDP atau Asian Handicap adalah sistem pemberian nilai tambah atau kurang (voor) berupa gol kepada salah satu tim. Tim yang lebih kuat biasanya akan memberikan voor kepada tim yang lebih lemah untuk menyeimbangkan peluang.",
                    "Over/Under (O/U) atau Atas/Bawah adalah jenis taruhan di mana pemain menebak total gol yang tercipta dalam suatu pertandingan, apakah berada di atas (Over) atau di bawah (Under) batas angka yang telah ditentukan.",
                    "1x2 adalah format taruhan klasik tanpa handicap. Angka \"1\" mewakili kemenangan tuan rumah (Home), \"X\" mewakili hasil seri (Draw), dan \"2\" mewakili kemenangan tim tamu (Away).",
                    "Odd/Even (O/E) atau Ganjil/Genap adalah taruhan yang menebak apakah total keseluruhan gol dari kedua tim yang bertanding pada akhir laga akan bernilai ganjil atau genap.",
                ],
                'meta' => null,
            ],
            [
