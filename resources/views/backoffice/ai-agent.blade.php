                        ...
                        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            <div class="rounded-2xl border border-white/10 bg-slate-900/50 px-4 py-3">
                                ...
                                <input id="bot_name" type="text" name="bot_name" value="{{ $aiInfo['bot_name'] }}"
                                    class="mt-1 block w-full rounded-xl border border-white/10 bg-slate-900 px-3 py-2 text-sm font-semibold text-black outline-none transition focus:border-cyan-400" />
                            </div>
                            <div class="rounded-2xl border border-white/10 bg-slate-900/50 px-4 py-3">
