            ...
            <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1rem">
                ...
                <div>
                    ...
                    <select id="model" name="model">
                        <?php $currentModel = old('model', 'gpt-4.1-mini'); ?>
                        <optgroup label="── GPT-5 Series ──">
                            <option value="gpt-5" {{ $currentModel === 'gpt-5' ? 'selected' : '' }}>gpt-5 — ★★★★★ Latest
                                flagship, most intelligent</option>
                        </optgroup>
            ...
            <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:1rem;align-items:end">
                ...
                <div>
                    ...
                    <select id="timezone" name="timezone">
                        @php($selectedTimezone = old('timezone', config('app.timezone', 'Asia/Jakarta')))
