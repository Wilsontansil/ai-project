        ...
        <form method="POST" action="{{ route('backoffice.tools.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea id="missing_message" name="missing_message" rows="3"
                    ...
                    style="color:#000" class="w-full rounded-2xl border border-white/10 bg-slate-900/70 px-4 py-3 text-sm text-black outline-none transition focus:border-cyan-400">{{ old('missing_message') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea id="information_text" name="information_text" rows="4"
                    ...
                    style="color:#000" class="w-full rounded-2xl border border-white/10 bg-slate-900/70 px-4 py-3 text-sm text-black outline-none transition focus:border-cyan-400">{{ old('information_text') }}</textarea>
            </div>
